...
int main() {
    ...
    for (int i = 0; i < 1000; ++i) {
        ...
        case 0: ++(movePosition.y); break;
        case 1: --(movePosition.y); break;
        case 2: ++(movePosition.x); break;
        case 3: --(movePosition.x); break;
        }
    ...
    while (1) {
        ...
        Vec2 movePosition = blankPosition;
        switch (_getch()) {
        case 'w': ++(movePosition.y); break;
        case 's': --(movePosition.y); break;
        case 'a': ++(movePosition.x); break;
        case 'd': --(movePosition.x); break;
        }
        moveBlank(movePosition);
    }
